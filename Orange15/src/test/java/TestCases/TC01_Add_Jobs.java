...
public class TC01_Add_Jobs
{
	...
	public void TC01_Add_Jobs(WebDriver driver,Reporter1 R1 ) throws Exception {
		this.driver = driver;
		this.R1 = R1;
	}
...
public static Object[][] Authentication1() throws Exception {
	...
	Object[][] testObjArray = eat.getTableArray("C://HTML Report//OrangeHRM6//TC01_jobs81.xlsx", "Sheet1");
...
@Test(dataProvider = "TC01_Add_Jobs")
public void Nationality_call_allmethods(String TestURL,String UserName, String Password,
	...
	if (iRow==0)
	{
		...
		String str= "TC01_Add_Jobs".concat("_Iterration_").concat(String.valueOf(iRow)) ;
